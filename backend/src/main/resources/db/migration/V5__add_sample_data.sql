-- ============================================================
-- DONNÉES SUPPLÉMENTAIRES - Commandes et Dépenses
-- Version 5 - Migration Flyway
-- ============================================================

-- Ajouter quelques besoins supplémentaires pour les commandes
...
-- Ajouter des commandes liées aux besoins approuvés
...
-- Ajouter des dépenses correspondant aux commandes livrées
...
VALUES
(2, 'LOGICIEL', 14800.00, '2026-01-14 10:00:00.000', 'Microsoft Maroc', 'FACT-MS-2026-0042', 'Paiement licences Visual Studio Professional - 15 licences', 'VIREMENT', 2),
(4, 'FOURNITURE', 2350.00, '2026-01-11 14:00:00.000', 'Bureau Plus', 'FACT-BP-2026-0158', 'Paiement fournitures de bureau - Papier A4, stylos, classeurs', 'CHEQUE', 2);

-- Ajouter quelques dépenses supplémentaires (non liées à des besoins spécifiques)
INSERT INTO depenses (besoin_id, categorie, montant, date_depense, fournisseur, facture_numero, description, mode_paiement, enregistre_par)
VALUES
